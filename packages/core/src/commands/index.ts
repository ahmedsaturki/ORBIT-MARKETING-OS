...
const BUILTIN_COMMANDS: readonly CommandDefinition[] = [
  ...
  {
    id: "research.brief.create",
    title: "Create research brief",
    description: "Create a workspace-scoped research question and objectives.",
    risk: "medium",
  ...
  {
    id: "research.finding.capture",
    title: "Capture research finding",
    description: "Persist an evidence-backed workspace research finding.",
    risk: "medium",
    scopes: ["research:write"],
    surfaces: ["desktop", "web", "mobile", "cli", "mcp", "agent"],
    mutatesState: true,
