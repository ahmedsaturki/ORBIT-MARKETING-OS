...
| AN-03    | Deterministic metric anomaly detection uses only preceding observations and emits descriptive signals without causal/significance claims | anomaly unit tests + no-dispatch command contract |
