...
The current native search surface covers accounts, campaigns, content, contacts, conversations, messages, opportunities, work items, strategy, knowledge items and sources, media assets, agents, policies, experiments, research briefs, and research findings.
