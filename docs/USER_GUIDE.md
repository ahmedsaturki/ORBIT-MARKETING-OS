...
يمكن إنشاء أكثر من مساحة عمل محلية وتبديل المساحة النشطة من سطح Desktop. الحسابات والحملات والمحتوى والموافقات والـCRM وصندوق المحادثات والمهام والسجلات تُقرأ وتُكتب ضمن الـworkspace النشط.

للاستخدام الجماعي الحقيقي عبر عدة مستخدمين، تبقى هوية المستخدم وعضويات RBAC والمزامنة المشفرة بين الأجهزة ضمن بوابات الإطلاق قبل الإنتاج.
