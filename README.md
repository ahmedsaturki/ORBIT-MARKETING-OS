...
The product is designed around local ownership of sensitive data. The desktop/local runtime is the source of truth for private account state, campaigns, task queues, CRM records, and audit records. Native SQLite schema is versioned through v14, including the governed marketing operating model, persisted opportunities/insights, workspace-scoped task idempotency, and conservative startup crash recovery.
