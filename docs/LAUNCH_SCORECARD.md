...
The latest rebuild CI run `36049164892` created jobs `107795977054` and `107795977291` and both failed before any workflow step executed: `runner_id=0`, empty runner name, and `steps=[]`. This is execution-infrastructure evidence, not source-build evidence.
