...
| Migration path                                  | IMPLEMENTED | Versioned schema through v15 with legacy backfill, outcome/operating-model migration and transactional migrations                                             |
...
| Desktop UI                                      | IMPLEMENTED | Workspace, content, approvals, tasks, CRM, inbox, backup, license, audit, Research Studio, Universal Search                                                                                      |
